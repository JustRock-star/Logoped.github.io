...
document.getElementById('checkBtn').onclick = function() {
    ...
    const correctPairs = [
        { text: document.querySelector('.item1Bottom'), imageClass: 'item2Top' },
        { text: document.querySelector('.item2Bottom'), imageClass: 'item3Top' },
        { text: document.querySelector('.item3Bottom'), imageClass: 'item1Top' }
    ];
