    ...
    dropZones.forEach(dropZone => {
        ...
        texts.forEach(textEl => {
            ...
            if (dist < 90) { // 90px — радиус прилипания
                // Ставим текст ровно внутрь зоны (центр с трансформом)
                ...
                textEl.style.transform = 'translate(-50%, -70%)';
...
document.getElementById('checkBtn').onclick = function() {
    ...
    const correctPairs = [
        { text: document.querySelector('.item1Bottom'), dropZoneData: 'item2Top' },
        { text: document.querySelector('.item2Bottom'), dropZoneData: 'item3Top' },
        { text: document.querySelector('.item3Bottom'), dropZoneData: 'item1Top' }
    ];
