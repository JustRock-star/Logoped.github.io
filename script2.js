    ...
    dropZones.forEach(dropZone => {
        ...
        texts.forEach(textEl => {
            ...
            if (dist < 90) { // радиус прилипания
                ...
                textEl.style.transform = 'translate(-50%, -60%)';
...
document.getElementById('checkBtn').onclick = function() {
    ...
    if (allCorrect) {
        ...
        setTimeout(() => {
            ...
            moveUp(document.querySelector('.item1Bottom'), 100);
            moveUp(document.querySelector('.item2Bottom'), 100);
            moveUp(document.querySelector('.item3Bottom'), 100);
        }, 5000);
    }
};
